use gpu_video::parameters::{ColorRange, ColorSpace};

use super::{WgpuConverterInitError, WgpuConverterParameters, WgpuSampler};

/// Helper that lets you convert RGBA (and BGRA) [`wgpu::Texture`] into NV12 [`wgpu::Texture`].
...
impl WgpuRgbaToNv12Converter {
    pub fn new(
        ...
        assert!(
            ...
            "Only Rgba8Unorm and Bgra8Unorm are supported"
        );
