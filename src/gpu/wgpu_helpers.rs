//! Module adapted from gpu-video "0.4.0" (https://github.com/software-mansion/smelter/tree/v0.6.0/gpu-video)
//! to apply a small patch to WgpuRgbaToNv12::create_input_bind_group.
